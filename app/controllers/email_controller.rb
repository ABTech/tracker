            ...
            when File_Action_File_Event
                ...
                when File_Action_New_Event
                    event = Event.new(params.require(:event).permit(
                      :title, :org_type, :organization_id, :org_new, :status, :rental, :publish, :billable,
                      :contact_name, :contactemail, :contact_phone, :price_quote, :notes,
                      :eventdates_attributes =>
                        [:startdate, :description, :enddate, :calldate, :strikedate, :calltype, :striketype,
