...
class EmailController < ApplicationController
  ...
  Event_ID_Regex                = /\[event ([0-9]+)\]/
    ...
    def send_weekly
      ...
      EmailMailer.weekly_events(current_member, params[:subject], params[:intro_blurb], params[:outro_blurb], @eventdates).deliver
